 ...
 * 系统管理 -> 基础信息设置 ->权限组
 *
 * @author zhoujian on 2021/9/1 0001 14:43
 */
...
public class PermissionController {
    ...
    /*
    * 因为整个项目是用了SpringSecurity,SpringSecurity用的角色都是用ROLE_ 开头的，
    * 所以我们在添加角色的时候，先判断有没有ROLE_下划线开头，如果没有，就加上。
    * 否则不会被SpringSecurity掌控。
    * */
